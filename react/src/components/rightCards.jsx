  ...
  return (
    <aside className="flex flex-col min-w-full">
      <section className="relative w-full p-2 my-2 ml-2 bg-white dark:bg-[#191a1b] shadow-sm rounded-xl">
        <header className="flex items-center justify-between p-2 mb-2 dark:text-white">
          <h2 className="font-bold text-md">Add to your feed</h2>
          <span className="inline-grid w-6 font-bold bg-gray-300 dark:bg-[#2f3031] rounded-full max-w-6 place-items-center aspect-square"><BsInfo className="text-xl dark:bg-transparent" /></span>
        </header>
        <div className="flex flex-col">
          <main className="flex items-center m-2 gap-x-4">
            ...
            <article>
              <h2 className="text-lg font-bold dark:text-white">Linkedin</h2>
              <span className="text-xs font-semibold text-gray-400 xl:text-sm">Company 🞄 Internet</span>
            </article>
          </main>
          <button className="flex gap-x-3 bg-[#e5eff4] dark:bg-[#162127] rounded-full px-3 py-2 items-center ml-[4.67rem] lg:ml-20 w-fit text-[#3585ae]">
            <BsPlusLg className="text-xl" /> <span className="inline-block font-semibold">Follow</span>
          </button>
        </div>
        <hr className="w-[95%] mx-2 my-4 dark:border-[#2f3031]" />
        <div className="flex flex-col">
          <main className="flex items-center m-2 gap-x-4">
            ...
            <article>
              <h2 className="text-lg font-bold dark:text-white">Microsoft</h2>
        ...
        <div className="flex flex-col">
          <main className="flex items-center m-2 gap-x-4">
            ...
            <article>
              <h2 className="text-lg font-bold dark:text-white">Apple</h2>
      ...
      <section className="relative w-full p-2 my-2 ml-2 bg-white dark:bg-[#191a1b] shadow-sm rounded-xl">
        <header className="flex items-center justify-between p-2 dark:text-white">
          ...
          <span className="inline-grid w-6 font-bold bg-gray-300 dark:bg-[#2f3031] rounded-full max-w-6 place-items-center aspect-square"><BsInfo className="text-xl" /></span>
        </header>
        <main>
          <div className="flex items-center justify-between p-3 mx-2 my-3 bg-gray-100 dark:bg-[#242526] rounded-lg gap-x-3">
            ...
            <article className="flex flex-col min-w-0 mr-auto text-sm">
              <span className="inline-block font-semibold truncate line-clamp-1 dark:text-white">UI/UX Design</span>
          ...
          <div className="flex items-center justify-between p-3 mx-2 my-3 bg-gray-100 dark:bg-[#242526] rounded-lg gap-x-3">
            ...
            <article className="flex flex-col min-w-0 mr-auto text-sm">
              <span className="inline-block font-semibold truncate line-clamp-1 dark:text-white">Illustrations</span>
              <span className="truncate text-muted-foreground dark:text-white">Emma Green</span>
            </article>
            <button className="block py-3 px-5 rounded-lg bg-[#e9e9e9] text-sm font-bold text-gray-600 dark:bg-[#2f3031] dark:text-muted-foreground">View</button>
          </div>
